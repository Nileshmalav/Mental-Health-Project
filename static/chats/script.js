$(document).ready(function () {
  ...
  $(document).on("click", ".contact", function (e) {
    ...
    $.get("/chats/to/"+touser_username,
    {   
      
    },
    function(data){
              $(".chat__messages").html(data);
      ...
      const roomName = touser_username;
      ...
      chatSocket.onmessage = function (e) {
        ...
        console.log(data.sender,data.message,data.time_stamp)
